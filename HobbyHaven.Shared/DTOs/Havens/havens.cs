...
namespace HobbyHaven.Shared.DTOs.Havens
{
    public class DTOHaven
    {
        ...
        public List<DTOHobbyBasic> Hobbies { get; set; } = new(); // List of hobbies havens the haven is enrolled in.
    ...
    public class DTOHavenBasic
    {
        public string Name { get; set; }
        public List<Guid> Hobbies { get; set; } = new(); // List of hobbies havens the haven is enrolled in.
        public Guid Id { get; set; } // Unique id for the hobby haven
        public string Location { get; set; }
        public string? Address { get; set; } = null; // Address
        public string Description { get; set; }
